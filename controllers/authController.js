...
exports.forgotPassword = catchAsync( async (req, res, next) => {
    ...
    // 3) Send it back as an email => Here we will send the original token , and not the encrypted one.
...
exports.resetPassword = catchAsync(async (req, res, next) => {
    ...
    user.password = req.body.password //Because we will send the password via body.
    user.passwordConfirm = req.body.passwordConfirm //Because we will send the passwordConfirm via body.
