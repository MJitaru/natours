...
const tourSchema = new mongoose.Schema({
    ...
    ratingsAverage: {
      ...
      set: val => Math.round(val * 10)/10  //4.666666 => 46.6666 round to 47 => after division by 10 = 4.7
    },
    ratingsQuantity:{
      type: Number,
      default: 0
    ...
    priceDiscount: {
      ...
      validate: {
        ...
        validator: function (val) {
          ...
          return val < this.price; // price discount 100 < real price 200 => true
        },
  ...
  tourSchema.index({price: 1, ratingsAverage:-1}); // 1 = sorting the price in an ascending order (-1 = descending order)
